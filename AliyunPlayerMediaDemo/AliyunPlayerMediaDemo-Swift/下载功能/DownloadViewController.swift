...
class DownloadViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,AliyunVodDownLoadDelegate,DownloadViewDelegate,CellClickDelegate,AliyunVodPlayerViewDelegate {
    func onGet(_ stsData: AliyunStsData!, videoID: String!, format: String!, quality: AliyunVodPlayerVideoQuality) {
    ...
    func aliyunVodPlayerView(_ playerView: AliyunVodPlayerView!, fullScreen isLockScreen: Bool) {
        isLock = isLockScreen
    }
