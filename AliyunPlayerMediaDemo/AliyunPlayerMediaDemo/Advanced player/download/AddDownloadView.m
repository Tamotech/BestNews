...
- (void)qualityRequest:(UIButton *)sender {
    ...
    NSString *urlstring = [NSString stringWithFormat:@"http://demo-vod.cn-shanghai.aliyuncs.com/voddemo/CreateSecurityToken?BusinessType=vodai&TerminalType=iphone&DeviceModel=%@&UUID=%@&VideoId=%@&AppVersion=1.0.0,",deviceModel,uuid,vid];
