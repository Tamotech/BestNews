...
public struct HRToastConfig {
    var HRToastDefaultDuration  =   1.0
    ...
    // label setting
    var HRToastMaxWidth       :  CGFloat  = 0.5;      // 80% of parent view width
    var HRToastMaxHeight      :  CGFloat  = 0.5;
    ...
    var HRToastOpacity        : CGFloat   = 0.8
    var HRToastCornerRadius   : CGFloat   = 8.0
    
    /*
     *  Custom Config
     */
    var HRToastHidesOnTap       =   true
    var HRToastDisplayShadow    =   false
