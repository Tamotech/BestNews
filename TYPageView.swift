...
class TYPageView: UIView {
    ...
    fileprivate lazy var titleView: TYPageTitleView = {
        let titleView:TYPageTitleView = TYPageTitleView(frame: CGRect(x: 0, y: 20, width: self.bounds.size.width, height: self.style.labelHeight), titles: self.titles, style: self.style)
    ...
    fileprivate lazy var collectionView: UICollectionView = {
        ...
        let collection:UICollectionView = UICollectionView(frame: CGRect(x: 0, y: 0, width: self.bounds.size.width, height: self.bounds.size.height), collectionViewLayout: layout)
